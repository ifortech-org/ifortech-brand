        ...
        <div>
          {image && image.asset?._id && (
            <div className="flex items-center justify-center">
              <div className="mb-4 relative h-[15rem] sm:h-[20rem] md:h-[25rem] lg:h-[9.5rem] xl:h-[12rem] rounded-md overflow-hidden aspect-video border-4 border-primary">
                <Image
          ...
          <div
            ...
            {title && (
              <div className="flex justify-between items-center mb-4">
                <h3 className="font-bold text-2xl text-center w-full">{title}</h3>
              </div>
            )}
            {excerpt && <p>{excerpt}</p>}
          </div>

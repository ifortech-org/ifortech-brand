...
// Source: ./sanity/queries/contactform/contactform.ts
// Variable: contactformQuery
// Query: *[_type == "contactform"]{  title,  description,  button_text,  side_image{    asset->{      url    },    alt  }}
export type ContactformQueryResult = Array<never>;
